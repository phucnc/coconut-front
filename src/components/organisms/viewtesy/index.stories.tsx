...
import { Viewtesy, UserType } from './index';
...
storiesOf('Components|organisms/Productcard', module)
  .add('normal', () => (
    <form>
      <Viewtesy title="Desert" bmp={2000} src={img} alt="abs" userList={users} id={0}></Viewtesy>
    </form>
  ))
  .add('bid', () => (
    <Viewtesy title="Desert" bmp={2000} bidPrice="12" src={img} alt="abs" userList={users} id={0}></Viewtesy>
  ));
